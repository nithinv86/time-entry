...
module.exports = {
  logTaskHoursAndSync: async (project = '139011000000148327') => {
    ...
    for (const task of tasks) {
      ...
      const resultDate = addMinutes(startOfDay(new Date()), task.duration);

      duration = format(resultDate, 'HH:mm');
